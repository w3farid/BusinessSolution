...
CREATE TABLE `sales` (
  ...
  CONSTRAINT `Emp_id_SR` FOREIGN KEY (`Emp_Id`) REFERENCES `employee` (`Emp_Id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2016-09-05  8:55:36
